...
OBJECTS += ./functimer.o
OBJECTS += ./main.o
OBJECTS += ./mbed-coremark-lm32-printf/cvt.o
OBJECTS += ./mbed-coremark-lm32-printf/ee_printf.o
OBJECTS += ./mbed-memory-status/RTT/SEGGER_RTT.o
OBJECTS += ./mbed-memory-status/mbed_memory_status.o
...
INCLUDE_PATHS += -I.././mbed-coremark-lm32-printf
INCLUDE_PATHS += -I.././mbed-memory-status
INCLUDE_PATHS += -I.././mbed-memory-status/RTT
...
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32F7/TARGET_STM32F767xI/device/Debug
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1521074467.02
C_FLAGS += -DTARGET_M7
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1521074467.02
...
ASM_FLAGS += -I./mbed-coremark-lm32-printf
ASM_FLAGS += -I./mbed-memory-status
ASM_FLAGS += -I./mbed-memory-status/RTT
ASM_FLAGS += -I./mbed-os
...
ASM_FLAGS += -I./mbed-os/targets/TARGET_STM/TARGET_STM32F7/TARGET_STM32F767xI/device/Debug
